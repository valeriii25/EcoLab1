 ...
 *
 */
static int16_t ECOCALLMETHOD CEcoLab1_SelectionSort(IEcoLab1Ptr_t me, void* pData, size_t elem_count, size_t elem_size, int16_t (ECOCALLMETHOD *comp)(const void *, const void *)) {
    CEcoLab1* pCMe = (CEcoLab1*)me;
    size_t i, j, min_idx;
